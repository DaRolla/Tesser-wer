...
public class Scale {
    ...
    public enum ScaleType {
        ...
        /*
         * Compute a scale that will maintain the original src aspect ratio, but will also ensure that src fits entirely
         * inside dst. May shrink or expand src to fit dst.
         */
        FIT,

        /*
         * Compute a scale that will maintain the original src aspect ratio, but will also ensure that src fits entirely
         * inside dst. May shrink src to fit dst, but will not expand it.
         */
        FIT_SHRINK,
    }
    ...
    private static native long nativeScaleGeneral(long nativePix, float scaleX, float scaleY, float sharpfract,
            int sharpwidth);
